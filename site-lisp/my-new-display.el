...
;(setq bgcolor "white")				 ;LightYellow
;(setq fgcolor "black")
;===================================================================
...
;; 	(font .  "-*-Courier New-normal-r-*-*-8-82-*-*-c-*-*-ansi-")
	(font .  "-*-Courier New-normal-r-*-*-12-82-*-*-c-*-*-ansi-")
	)
      )
...
;=================================================================
(defconst emacs-build-system (substring system-name 0 8))
(setq remote-system 
      (upcase (format "%s" emacs-build-system))
      )

(setq frame-title-format '(
			   (format "%s" remote-system)
			   "\-\-"
...
(setq frame-icon-title-format "Nogales Dev")
...
;  (set-face-foreground 'font-lock-type-face "Dark Green") ; int, char
